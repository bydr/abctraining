                                    ...
                                    <div class="page-testing">
                                        <div class="page-testing__header">
                                            ...
                                            <div class="page-testing__header__control">
                                                ...
                                                <p class="page-testing__title">Разминка</p>
                                                    ...
                                                    <div class="task-item__info">
                                                        <div class="task-item__info_inner">
                                                            <div class="task-item__controls">
                                                                <p class="dr-text__big c-accent_darker text-center fw-normal m-0">
                                                                    Обязательно разомнитесь (даже если уже разогреты) и переходите к следующему шагу
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
