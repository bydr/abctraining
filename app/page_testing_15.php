                                    ...
                                    <div class="page-testing">
                                        <div class="page-testing__header">
                                            ...
                                            <div class="page-testing__header__control">
                                                ...
                                                <p class="page-testing__title">Отжимания</p>
                                                            ...
                                                            <div class="task-item__controls">
                                                                <div class="step-item">
                                                                    <p class="step-item__title">
                                                                        <span class="label-step">Шаг 1</span>Левая рука сверху:
                                                                    </p>
                                                                    <div class="radio-list">
                                                                        <label class="radio">
                                                                            ...
                                                                            <span class="radio-text">Без касания пола</span>
                                                                        </span>
                                                                        </label>
                                                                        <label class="radio">
                                                                            ...
                                                                            <span class="radio-text">Касание пола пальцами</span>
                                                                        </span>
                                                                        </label>
                                                                        <label class="radio">
                                                                            <input type="radio" name="group1">
                                                                ...
                                                                <div class="step-item">
                                                                    <p class="step-item__title">
                                                                        <span class="label-step">Шаг 2</span>Укажите количество раз за 60 секунд:</p>
